...
const CLOUDS = [
  { cx: 22, cy: 20, rx: 30, ry: 20, hue: '--cyan' },
  { cx: 78, cy: 30, rx: 28, ry: 22, hue: '--accent-2' },
  { cx: 58, cy: 70, rx: 32, ry: 22, hue: '--magenta' },
  { cx: 18, cy: 76, rx: 26, ry: 18, hue: '--teal' },
  { cx: 90, cy: 84, rx: 24, ry: 18, hue: '--violet' },
]

export function NebulaPlate() {
  return (
    <div aria-hidden className="absolute inset-0" style={{ mixBlendMode: 'screen', opacity: 0.5 }}>
